...
//import { CryptoDashboardComponent } from './views/crypto/crypto-dashboard/crypto-dashboard.component'; // Assurez-vous d'importer votre composant
...
export const rootRouterConfig: Routes = [
  ...
  
  {
    ...
    children: [
      ...
      // Ajout de la route pour Crypto
     // {
       // path: 'crypto-dashboard',
       // component: CryptoDashboardComponent,  // Le composant que vous avez créé
        //data: { title: 'Crypto Dashboard', breadcrumb: 'CRYPTO' }
      //}
    ]
  },
  {
